...
public class PietroController {
    ...
    public void setDane(int id_prowadzacy, String rola, int pietro) throws Exception {
    ...
    public void handle_sala(ActionEvent event, int sala) throws Exception {
        ...
        controller.setDane(id_prowadzacy, rola, pietro, sala);
    ...
    public void handle_wstecz(ActionEvent event) throws Exception {
        ...
        controller.setDane(id_prowadzacy, rola);
